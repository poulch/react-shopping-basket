...
const PaymentAdd: React.FunctionComponent<RouteComponentProps & IProps> = ({
  addCard,
  history
}) => (
  <Formik
    ...
    render={() => (
      <Form>
        ...
        <div className={styles.inputContainer}>
          <Field type="number" name="cvc" label="Kod CVC" component={Input} />

          <ErrorMessage className={styles.error} name="cvc" component="div" />
        </div>
